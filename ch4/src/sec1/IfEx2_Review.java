...
//아니면 "일반학생"
		...
		System.out.println("edps 점수 : ");
		edps = sc.nextInt();
		System.out.println("pl 점수 : ");
		pl = sc.nextInt();
		...
		String pan = "";
		if(avg >= 70 && edps >= 70 && pl >= 70 && db >= 70) {
			System.out.println(pan = "합격");
		} else { 
			System.out.println(pan = "불합격");
		}
		...
		System.out.println(tot +"\t"+ avg+"\t"+ pan+"\t"+ hak +"\t"+
		dv);
	}
